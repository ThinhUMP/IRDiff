    ...
    def __getitem__(self, idx):
        if isinstance(idx, list):
            return (
                ...
                self.dataset[[self.prompt_indices[i] for i in idx]],
            )
    ...
    def __getitem__(self, idx):
        ...
        if self.topK == 1:
            ...
            return (
                ...
                self.dataset[prompt_1st_indices[idx]],
                self.dataset[prompt_2nd_indices[idx]],
                self.dataset[prompt_3rd_indices[idx]],
            )
