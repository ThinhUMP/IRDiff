...
from utils.transforms import (
    MAP_INDEX_TO_ATOM_TYPE_ONLY,
    MAP_INDEX_TO_ATOM_TYPE_AROMATIC,
    MAP_INDEX_TO_ATOM_TYPE_FULL,
...
def get_auroc(y_true, y_pred, feat_mode):
    ...
    for c in possible_classes:
        ...
        mapping = {
            "basic": MAP_INDEX_TO_ATOM_TYPE_ONLY,
            "add_aromatic": MAP_INDEX_TO_ATOM_TYPE_AROMATIC,
            "full": MAP_INDEX_TO_ATOM_TYPE_FULL,
        }
...
if __name__ == "__main__":
    ...
    ligand_featurizer = FeaturizeLigandAtom(config.data.transform.ligand_atom_mode)
    transform_list = [
        protein_featurizer,
        ligand_featurizer,
        FeaturizeLigandBond(),
